...
{
  [Theory]
  [InlineData(0b1111_0000, 0b1010_1010, 0b1010_0000, false, true)]
  [InlineData(0b0000_1111, 0b1010_1010, 0b0000_1010, false, false)]
  [InlineData(0b1111_0000, 0b0000_1111, 0b0000_0000, true, false)]
    ...
    bool negative)
  {
    ...
    var cycles = cpu.AND_immediate(operand);
  ...
  [Fact]
  public void And_PreservesUnrelatedFlags()
  {
    var bus = new Bus();
    var cpu = new Emulator(bus);
  ...
  public void And_ZeroPage_ReadsOperandAndReturnsThreeCycles()
  {
    ...
    var cycles = cpu.AND_zero_page(0x42);

    cpu.A.Should().Be(0x0C);
    cycles.Should().Be(3);
  }
  ...
  public void And_ZeroPageX_AppliesXOffsetAndReturnsFourCycles()
  {
    ...
    var cycles = cpu.AND_zero_page_x(0x80);
  ...
  [Fact]
  public void And_ZeroPageX_WrapsWithinZeroPage()
  {
    var bus = new Bus();
    ...
    var cycles = cpu.AND_zero_page_x(0xFF);
  ...
  public void And_Absolute_ReadsOperandAndReturnsFourCycles()
  {
    ...
    var cycles = cpu.AND_absolute(0x1234);
  ...
  public void And_AbsoluteX_AppliesXOffsetWithoutPageCrossing()
  {
    ...
    var cycles = cpu.AND_absolute_x(0x2000);
  ...
  public void And_AbsoluteX_AddsCycleWhenPageIsCrossed()
  {
    ...
    var cycles = cpu.AND_absolute_x(0x20FF);
  ...
  public void And_AbsoluteY_AppliesYOffsetWithoutPageCrossing()
  {
    ...
    var cycles = cpu.AND_absolute_y(0x3000);
  ...
  public void And_AbsoluteY_AddsCycleWhenPageIsCrossed()
  {
    ...
    var cycles = cpu.AND_absolute_y(0x30FF);
  ...
  public void And_IndexedIndirect_AppliesXOffsetAndReadsIndirectAddress()
  {
    ...
    var cycles = cpu.AND_indexed_indirect(0x20);
  ...
  [Fact]
  public void And_IndexedIndirect_WrapsPointerWithinZeroPage()
  {
    var bus = new Bus();
    ...
    var cycles = cpu.AND_indexed_indirect(0xFF);
  ...
  public void And_IndirectIndexed_AppliesYOffsetWithoutPageCrossing()
  {
    ...
    var cycles = cpu.AND_indirect_indexed(0x40);
  ...
  [Fact]
  public void And_IndirectIndexed_WrapsPointerWithinZeroPage()
  {
    var bus = new Bus();
    ...
    var cycles = cpu.AND_indirect_indexed(0xFF);
